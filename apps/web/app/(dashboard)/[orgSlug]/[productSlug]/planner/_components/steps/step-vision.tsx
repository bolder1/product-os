...
import { Lightbulb, Plus, X, Target, TrendingUp, DollarSign, Users, Zap } from 'lucide-react'
...
export default function StepVision({ problem, goals, onProblemChange, onGoalsChange }: StepVisionProps) {
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <span
                    ...
                    style={{
                      backgroundColor: categoryColor(goal.category) + '15',
                      color: categoryColor(goal.category),
                    }}
                  >
                    {goal.category}
                  </span>
