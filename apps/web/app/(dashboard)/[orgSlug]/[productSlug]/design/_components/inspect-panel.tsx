  ...
  return (
    <div className="flex items-center justify-between py-1.5 group">
      ...
      <div className="flex items-center gap-1.5">
        <span className="text-[11px] text-[#F1F5F9] font-mono">{value}</span>
  ...
  return (
    <div className="flex items-center gap-2 py-1.5 group">
      ...
      <div className="flex-1 flex items-center justify-between min-w-0">
        ...
        <div className="flex items-center gap-1.5">
          <span className="text-[10px] text-[#94A3B8] font-mono truncate">{color}</span>
          <div className="opacity-0 group-hover:opacity-100 transition-opacity">
    ...
    return (
      <div className="h-full flex items-center justify-center">
        <div className="text-center space-y-2 px-4">
          <p className="text-sm text-[#64748B]">Inspect Mode</p>
          <p className="text-[11px] text-[#475569]">Select an element to see its CSS properties</p>
        </div>
      </div>
    )
  }
    ...
    <div className="h-full flex flex-col overflow-hidden">
      ...
      <div className="shrink-0 px-4 py-3 border-b border-white/[0.08]">
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-xs font-semibold text-[#F1F5F9]">Inspect: {element.type}</p>
            <p className="text-[10px] text-[#64748B]">{element.id}</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-white/10">
        ...
        <div className="px-4 py-3 border-b border-white/[0.06]">
          <p className="text-[10px] uppercase tracking-widest text-[#64748B] font-semibold mb-3">Spacing</p>
        ...
        {/* CSS Properties */}
        <div className="px-4 py-3 border-b border-white/[0.06]">
          <p className="text-[10px] uppercase tracking-widest text-[#64748B] font-semibold mb-2">Properties</p>
        ...
        {/* Colors */}
        <div className="px-4 py-3 border-b border-white/[0.06]">
          <p className="text-[10px] uppercase tracking-widest text-[#64748B] font-semibold mb-2">Colors</p>
        ...
        {element.style.fontSize && (
          <div className="px-4 py-3 border-b border-white/[0.06]">
            <p className="text-[10px] uppercase tracking-widest text-[#64748B] font-semibold mb-2">Typography</p>
            <div className="divide-y divide-white/[0.04]">
        ...
        <div className="px-4 py-3">
          <p className="text-[10px] uppercase tracking-widest text-[#64748B] font-semibold mb-2">Generated CSS</p>
          <pre className="bg-white/[0.02] border border-white/[0.06] rounded-lg p-3 text-[10px] text-[#94A3B8] font-mono leading-relaxed overflow-x-auto whitespace-pre">
            {css}
          </pre>
        </div>
      </div>
        ...
        <motion.button
          ...
          className={`w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-xs font-medium transition-all ${
            cssCopied
              ...
              : 'bg-white/[0.04] border border-white/[0.08] text-[#F1F5F9] hover:bg-white/[0.06]'
          }`}
        >
          {cssCopied ? (
            <>
