    ...
    >
      ...
      <div className="relative">
        ...
        <input
          ...
          className="pl-8 pr-3 py-2 rounded-lg text-xs text-[var(--text-primary)] bg-white/[0.03] border border-white/[0.08] placeholder:text-[var(--text-tertiary)] focus:outline-none focus:border-[var(--accent)]/40 focus:ring-1 focus:ring-[var(--accent)]/20 w-48 transition-colors"
        />
      </div>
            ...
            <button
              ...
              className={`flex items-center gap-1.5 px-2 py-1.5 rounded-md text-[10px] font-medium transition-colors ${
                active
                  ...
                  : 'bg-white/[0.02] text-[var(--text-tertiary)] hover:text-[var(--text-secondary)]'
              }`}
            >
              <div
            ...
            <button
              ...
              className={`px-2 py-1.5 rounded-md text-[10px] font-medium transition-colors ${
                active
                  ...
                  : 'bg-white/[0.02] text-[var(--text-tertiary)]/50 hover:text-[var(--text-tertiary)]'
              }`}
            >
      ...
      <div className="flex items-center gap-1 ml-auto">
        <button
          ...
          className="flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-[10px] font-medium text-[var(--text-secondary)] bg-white/[0.03] border border-white/[0.08] hover:bg-white/[0.06] transition-colors"
        >
