        ...
        return (
          ...
          >
            ...
            <div className="flex items-center gap-2 mb-3 px-1">
              ...
              <span className="text-xs text-[#64748B] bg-white/[0.05] px-2 py-0.5 rounded-full ml-auto">
                {columnTasks.length}
              </span>
            </div>
            ...
            >
              ...
              {columnTasks.length === 0 && !isOver && (
                <div className="flex items-center justify-center h-24 text-xs text-[#64748B] border border-dashed border-white/[0.06] rounded-lg">
                  No tasks
                </div>
              )}
            </div>
