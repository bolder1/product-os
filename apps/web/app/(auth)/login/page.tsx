  ...
  return (
    ...
    >
      <svg width="380" height="420" viewBox="0 0 380 420" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        />
        <circle cx="190" cy="80" r="5" fill="#6398ff" />
        ...
        />
        <circle cx="90" cy="200" r="4.5" fill="#8b5cf6" />
        ...
        />
        <circle cx="290" cy="200" r="4.5" fill="#06b6d4" />
        ...
        />
        <circle cx="190" cy="310" r="5" fill="#6398ff" />
    ...
    <>
      ...
      >
        ...
        >
          {/* Add-account banner */}
          {isAddAccount && (
            <div className="flex items-center gap-2.5 px-4 py-3 mb-6 rounded-xl bg-[#6366F1]/10 border border-[#6366F1]/25 text-[#a5b4fc]">
          ...
          <div className="flex flex-col items-center gap-3 mb-8">
            {/* Product OS badge */}
            <div className="px-3 py-1 rounded-full border border-[#6398ff]/20 bg-[#6398ff]/[0.07] mb-1">
              <span className="text-[11px] font-medium tracking-wider uppercase text-[#6398ff]">
                Product OS
              </span>
            </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div>
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-4 py-2.5 rounded-lg bg-white/[0.03] border text-[#F1F5F9] placeholder:text-[#64748B] focus:outline-none transition ${
                    errors.email
                      ? 'border-red-500/60 focus:border-red-500/60 focus:shadow-[0_0_0_3px_rgba(239,68,68,0.10)]'
                      : 'border-white/[0.08] focus:border-[#6398ff]/50 focus:shadow-[0_0_0_3px_rgba(99,152,255,0.10)]'
                  }`}
                />
              </div>
              {errors.email && (
            ...
            <div>
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-10 py-2.5 rounded-lg bg-white/[0.03] border text-[#F1F5F9] placeholder:text-[#64748B] focus:outline-none transition ${
                    errors.password
                      ? 'border-red-500/60 focus:border-red-500/60 focus:shadow-[0_0_0_3px_rgba(239,68,68,0.10)]'
                      : 'border-white/[0.08] focus:border-[#6398ff]/50 focus:shadow-[0_0_0_3px_rgba(99,152,255,0.10)]'
                  }`}
            ...
            <div className="flex justify-end">
              <Link href="/forgot-password" className="text-xs text-[#6398ff] hover:text-[#7aa8ff] transition-colors">
                Forgot password?
              </Link>
            </div>
          ...
          <p className="text-center text-sm text-[#94A3B8] mt-6">
            ...
            <Link href="/signup" className="text-[#6398ff] hover:text-[#7aa8ff] font-medium transition-colors">
              Sign up
            </Link>
          </p>
        </div>
